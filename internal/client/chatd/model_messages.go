...
// checks if the Messages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Messages{}
...
func (o Messages) ToMap() (map[string]interface{}, error) {
