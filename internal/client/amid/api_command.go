...
type CommandAPI interface {
	...
	/*
		...
		**Required ACL:** `amid.action.Command.create`
...
func (a *CommandAPIService) CommandAsteriskManagerExecute(r ApiCommandAsteriskManagerRequest) (*CommandResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommandAPIService.CommandAsteriskManager")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/action/Command"
