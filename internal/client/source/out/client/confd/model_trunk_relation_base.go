...
// checks if the TrunkRelationBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrunkRelationBase{}

// TrunkRelationBase struct for TrunkRelationBase
type TrunkRelationBase struct {
	// The id of the trunk
...
func (o TrunkRelationBase) MarshalJSON() ([]byte, error) {
...
func (o TrunkRelationBase) ToMap() (map[string]interface{}, error) {
...
type NullableTrunkRelationBase struct {
	value *TrunkRelationBase
	isSet bool
}

func (v NullableTrunkRelationBase) Get() *TrunkRelationBase {
	return v.value
}

func (v *NullableTrunkRelationBase) Set(val *TrunkRelationBase) {
	v.value = val
	v.isSet = true
}

func (v NullableTrunkRelationBase) IsSet() bool {
	return v.isSet
}

func (v *NullableTrunkRelationBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrunkRelationBase(val *TrunkRelationBase) *NullableTrunkRelationBase {
	return &NullableTrunkRelationBase{value: val, isSet: true}
}

func (v NullableTrunkRelationBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrunkRelationBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
