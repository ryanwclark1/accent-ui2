...
// checks if the UserRelationIncall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserRelationIncall{}

// UserRelationIncall struct for UserRelationIncall
type UserRelationIncall struct {
...
func (o UserRelationIncall) MarshalJSON() ([]byte, error) {
...
func (o UserRelationIncall) ToMap() (map[string]interface{}, error) {
...
type NullableUserRelationIncall struct {
	value *UserRelationIncall
	isSet bool
}

func (v NullableUserRelationIncall) Get() *UserRelationIncall {
	return v.value
}

func (v *NullableUserRelationIncall) Set(val *UserRelationIncall) {
	v.value = val
	v.isSet = true
}

func (v NullableUserRelationIncall) IsSet() bool {
	return v.isSet
}

func (v *NullableUserRelationIncall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserRelationIncall(val *UserRelationIncall) *NullableUserRelationIncall {
	return &NullableUserRelationIncall{value: val, isSet: true}
}

func (v NullableUserRelationIncall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserRelationIncall) UnmarshalJSON(src []byte) error {
	v.isSet = true
