...
// DeviceOptions List of standard keys
type DeviceOptions struct {
	// Indicate if this device is a switchboard
	Switchboard *bool `json:"switchboard,omitempty"`
}
...
// SetSwitchboard gets a reference to the given bool and assigns it to the Switchboard field.
