...
// checks if the IvrRelationIncall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IvrRelationIncall{}

// IvrRelationIncall struct for IvrRelationIncall
type IvrRelationIncall struct {
...
func (o IvrRelationIncall) MarshalJSON() ([]byte, error) {
...
func (o IvrRelationIncall) ToMap() (map[string]interface{}, error) {
...
type NullableIvrRelationIncall struct {
	value *IvrRelationIncall
	isSet bool
}

func (v NullableIvrRelationIncall) Get() *IvrRelationIncall {
	return v.value
}

func (v *NullableIvrRelationIncall) Set(val *IvrRelationIncall) {
	v.value = val
	v.isSet = true
}

func (v NullableIvrRelationIncall) IsSet() bool {
	return v.isSet
}

func (v *NullableIvrRelationIncall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIvrRelationIncall(val *IvrRelationIncall) *NullableIvrRelationIncall {
	return &NullableIvrRelationIncall{value: val, isSet: true}
}

func (v NullableIvrRelationIncall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIvrRelationIncall) UnmarshalJSON(src []byte) error {
	v.isSet = true
