...
// checks if the SwitchboardRelationIncalls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwitchboardRelationIncalls{}

// SwitchboardRelationIncalls struct for SwitchboardRelationIncalls
type SwitchboardRelationIncalls struct {
...
func NewSwitchboardRelationIncalls() *SwitchboardRelationIncalls {
	this := SwitchboardRelationIncalls{}
	return &this
}
...
func (o SwitchboardRelationIncalls) MarshalJSON() ([]byte, error) {
...
func (o SwitchboardRelationIncalls) ToMap() (map[string]interface{}, error) {
...
type NullableSwitchboardRelationIncalls struct {
	value *SwitchboardRelationIncalls
	isSet bool
}

func (v NullableSwitchboardRelationIncalls) Get() *SwitchboardRelationIncalls {
	return v.value
}

func (v *NullableSwitchboardRelationIncalls) Set(val *SwitchboardRelationIncalls) {
	v.value = val
	v.isSet = true
}

func (v NullableSwitchboardRelationIncalls) IsSet() bool {
	return v.isSet
}

func (v *NullableSwitchboardRelationIncalls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwitchboardRelationIncalls(val *SwitchboardRelationIncalls) *NullableSwitchboardRelationIncalls {
	return &NullableSwitchboardRelationIncalls{value: val, isSet: true}
}

func (v NullableSwitchboardRelationIncalls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwitchboardRelationIncalls) UnmarshalJSON(src []byte) error {
	v.isSet = true
