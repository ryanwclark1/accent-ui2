...
**Required ACL:** none. A single meeting only accepts a maximum amount of 128 authorizations. Authorizations are valid for 24h.
	...
	@return ApiCreateGuestMeetingAuthorizationRequest
*/
func (a *GuestsAPIService) CreateGuestMeetingAuthorization(ctx context.Context, guestUuid string, meetingUuid string) ApiCreateGuestMeetingAuthorizationRequest {
	return ApiCreateGuestMeetingAuthorizationRequest{
		ApiService:  a,
		ctx:         ctx,
		guestUuid:   guestUuid,
...
//
//	@return MeetingAuthorization
func (a *GuestsAPIService) CreateGuestMeetingAuthorizationExecute(r ApiCreateGuestMeetingAuthorizationRequest) (*MeetingAuthorization, *http.Response, error) {
	var (
...
**Required ACL:** confd.users.me.meetings.{meeting_uuid}.authorizations.{authorization_uuid}.read
	...
	@return ApiDeleteUserMeetingAuthorizationRequest
*/
func (a *GuestsAPIService) DeleteUserMeetingAuthorization(ctx context.Context, guestUuid string, meetingUuid string, authorizationUuid string) ApiDeleteUserMeetingAuthorizationRequest {
	return ApiDeleteUserMeetingAuthorizationRequest{
		ApiService:        a,
		ctx:               ctx,
		guestUuid:         guestUuid,
...
// Execute executes the request
func (a *GuestsAPIService) DeleteUserMeetingAuthorizationExecute(r ApiDeleteUserMeetingAuthorizationRequest) (*http.Response, error) {
	var (
...
**Required ACL:** none
	...
	@return ApiGetGuestMeetingRequest
*/
func (a *GuestsAPIService) GetGuestMeeting(ctx context.Context, meetingUuid string) ApiGetGuestMeetingRequest {
	return ApiGetGuestMeetingRequest{
		ApiService:  a,
		ctx:         ctx,
		meetingUuid: meetingUuid,
...
//
//	@return Meeting
func (a *GuestsAPIService) GetGuestMeetingExecute(r ApiGetGuestMeetingRequest) (*Meeting, *http.Response, error) {
	var (
...
**Required ACL:** none
	...
	@return ApiGetGuestMeetingAuthorizationRequest
*/
func (a *GuestsAPIService) GetGuestMeetingAuthorization(ctx context.Context, guestUuid string, meetingUuid string, authorizationUuid string) ApiGetGuestMeetingAuthorizationRequest {
	return ApiGetGuestMeetingAuthorizationRequest{
		ApiService:        a,
		ctx:               ctx,
		guestUuid:         guestUuid,
...
//
//	@return MeetingAuthorization
func (a *GuestsAPIService) GetGuestMeetingAuthorizationExecute(r ApiGetGuestMeetingAuthorizationRequest) (*MeetingAuthorization, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
**Required ACL:** confd.users.me.meetings.{meeting_uuid}.authorizations.{authorization_uuid}.read
	...
	@return ApiGetUserMeetingAuthorizationRequest
*/
func (a *GuestsAPIService) GetUserMeetingAuthorization(ctx context.Context, guestUuid string, meetingUuid string, authorizationUuid string) ApiGetUserMeetingAuthorizationRequest {
	return ApiGetUserMeetingAuthorizationRequest{
		ApiService:        a,
		ctx:               ctx,
		guestUuid:         guestUuid,
...
//
//	@return MeetingAuthorization
func (a *GuestsAPIService) GetUserMeetingAuthorizationExecute(r ApiGetUserMeetingAuthorizationRequest) (*MeetingAuthorization, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
