...
// GetPresenceInitialization returns the PresenceInitialization field value if set, zero value otherwise.
func (o *StatusSummary) GetPresenceInitialization() ComponentWithStatus {
	if o == nil || IsNil(o.PresenceInitialization) {
		var ret ComponentWithStatus
		return ret
	}
	return *o.PresenceInitialization
}

// GetPresenceInitializationOk returns a tuple with the PresenceInitialization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StatusSummary) GetPresenceInitializationOk() (*ComponentWithStatus, bool) {
	if o == nil || IsNil(o.PresenceInitialization) {
		return nil, false
	}
	return o.PresenceInitialization, true
}
...
// SetPresenceInitialization gets a reference to the given ComponentWithStatus and assigns it to the PresenceInitialization field.
func (o *StatusSummary) SetPresenceInitialization(v ComponentWithStatus) {
	o.PresenceInitialization = &v
}
...
func (o StatusSummary) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PresenceInitialization) {
		toSerialize["presence_initialization"] = o.PresenceInitialization
	}
	if !IsNil(o.RestApi) {
