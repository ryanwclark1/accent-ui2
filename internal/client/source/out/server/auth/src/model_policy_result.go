...
// AssertPolicyResultRequired checks if the required fields are not zero-ed
func AssertPolicyResultRequired(obj PolicyResult) error {
...
// AssertPolicyResultConstraints checks if the values respects the defined constraints
func AssertPolicyResultConstraints(obj PolicyResult) error {
	return nil
}
