...
// AssertLdapBackendConfigEditRequired checks if the required fields are not zero-ed
func AssertLdapBackendConfigEditRequired(obj LdapBackendConfigEdit) error {
...
// AssertLdapBackendConfigEditConstraints checks if the values respects the defined constraints
func AssertLdapBackendConfigEditConstraints(obj LdapBackendConfigEdit) error {
