...
func (s *StatusAPIService) StatusSummary(ctx context.Context) (ImplResponse, error) {
	// TODO - update StatusSummary with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("StatusSummary method not implemented")
}
