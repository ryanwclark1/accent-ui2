...
// AssertConfBridgeConfigurationRequired checks if the required fields are not zero-ed
func AssertConfBridgeConfigurationRequired(obj ConfBridgeConfiguration) error {
	return nil
}

// AssertConfBridgeConfigurationConstraints checks if the values respects the defined constraints
func AssertConfBridgeConfigurationConstraints(obj ConfBridgeConfiguration) error {
	return nil
}
