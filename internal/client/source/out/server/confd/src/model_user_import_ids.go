...
// AssertUserImportIdsRequired checks if the required fields are not zero-ed
func AssertUserImportIdsRequired(obj UserImportIds) error {
	return nil
}

// AssertUserImportIdsConstraints checks if the values respects the defined constraints
func AssertUserImportIdsConstraints(obj UserImportIds) error {
	return nil
}
