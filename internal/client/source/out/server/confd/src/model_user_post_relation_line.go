...
// AssertUserPostRelationLineRequired checks if the required fields are not zero-ed
func AssertUserPostRelationLineRequired(obj UserPostRelationLine) error {
...
// AssertUserPostRelationLineConstraints checks if the values respects the defined constraints
func AssertUserPostRelationLineConstraints(obj UserPostRelationLine) error {
	return nil
}
