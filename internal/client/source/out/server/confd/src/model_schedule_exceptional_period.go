...
// AssertScheduleExceptionalPeriodRequired checks if the required fields are not zero-ed
func AssertScheduleExceptionalPeriodRequired(obj ScheduleExceptionalPeriod) error {
...
// AssertScheduleExceptionalPeriodConstraints checks if the values respects the defined constraints
func AssertScheduleExceptionalPeriodConstraints(obj ScheduleExceptionalPeriod) error {
	return nil
}
