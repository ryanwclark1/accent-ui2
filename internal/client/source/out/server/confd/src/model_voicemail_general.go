...
// AssertVoicemailGeneralRequired checks if the required fields are not zero-ed
func AssertVoicemailGeneralRequired(obj VoicemailGeneral) error {
	return nil
}

// AssertVoicemailGeneralConstraints checks if the values respects the defined constraints
func AssertVoicemailGeneralConstraints(obj VoicemailGeneral) error {
	return nil
}
