...
// AssertProvisioningNetworkingRequired checks if the required fields are not zero-ed
func AssertProvisioningNetworkingRequired(obj ProvisioningNetworking) error {
	return nil
}

// AssertProvisioningNetworkingConstraints checks if the values respects the defined constraints
func AssertProvisioningNetworkingConstraints(obj ProvisioningNetworking) error {
	return nil
}
