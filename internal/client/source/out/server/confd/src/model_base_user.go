...
// AssertBaseUserRequired checks if the required fields are not zero-ed
func AssertBaseUserRequired(obj BaseUser) error {
	return nil
}

// AssertBaseUserConstraints checks if the values respects the defined constraints
func AssertBaseUserConstraints(obj BaseUser) error {
	return nil
}
