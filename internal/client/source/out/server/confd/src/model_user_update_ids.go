...
// AssertUserUpdateIdsRequired checks if the required fields are not zero-ed
func AssertUserUpdateIdsRequired(obj UserUpdateIds) error {
	return nil
}

// AssertUserUpdateIdsConstraints checks if the values respects the defined constraints
func AssertUserUpdateIdsConstraints(obj UserUpdateIds) error {
	return nil
}
