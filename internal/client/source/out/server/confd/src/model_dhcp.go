...
// AssertDhcpRequired checks if the required fields are not zero-ed
func AssertDhcpRequired(obj Dhcp) error {
	return nil
}

// AssertDhcpConstraints checks if the values respects the defined constraints
func AssertDhcpConstraints(obj Dhcp) error {
	return nil
}
