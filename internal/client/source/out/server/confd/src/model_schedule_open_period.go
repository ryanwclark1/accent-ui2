...
// AssertScheduleOpenPeriodRequired checks if the required fields are not zero-ed
func AssertScheduleOpenPeriodRequired(obj ScheduleOpenPeriod) error {
	return nil
}

// AssertScheduleOpenPeriodConstraints checks if the values respects the defined constraints
func AssertScheduleOpenPeriodConstraints(obj ScheduleOpenPeriod) error {
	return nil
}
