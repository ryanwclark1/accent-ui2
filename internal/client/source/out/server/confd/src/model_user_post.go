...
// AssertUserPostRequired checks if the required fields are not zero-ed
func AssertUserPostRequired(obj UserPost) error {
	if err := AssertUserRelationAgentRequired(obj.Agent); err != nil {
		return err
	}
	if err := Assertmap[string]interface{}Required(obj.Auth); err != nil {
		return err
	}
...
// AssertUserPostConstraints checks if the values respects the defined constraints
func AssertUserPostConstraints(obj UserPost) error {
	return nil
}
