...
// AssertBaseVoicemailRequired checks if the required fields are not zero-ed
func AssertBaseVoicemailRequired(obj BaseVoicemail) error {
...
// AssertBaseVoicemailConstraints checks if the values respects the defined constraints
func AssertBaseVoicemailConstraints(obj BaseVoicemail) error {
	return nil
}
