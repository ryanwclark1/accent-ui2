...
// AssertIaxGeneralRequired checks if the required fields are not zero-ed
func AssertIaxGeneralRequired(obj IaxGeneral) error {
	return nil
}

// AssertIaxGeneralConstraints checks if the values respects the defined constraints
func AssertIaxGeneralConstraints(obj IaxGeneral) error {
	return nil
}
