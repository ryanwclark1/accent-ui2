...
// AssertUserRelationVoicemailCreateVoicemailRequired checks if the required fields are not zero-ed
func AssertUserRelationVoicemailCreateVoicemailRequired(obj UserRelationVoicemailCreateVoicemail) error {
...
// AssertUserRelationVoicemailCreateVoicemailConstraints checks if the values respects the defined constraints
func AssertUserRelationVoicemailCreateVoicemailConstraints(obj UserRelationVoicemailCreateVoicemail) error {
	return nil
}
