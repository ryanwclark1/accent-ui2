...
func (s *ConfigAPIService) UpdateConfig(ctx context.Context, configPatch []ConfigPatchItem) (ImplResponse, error) {
	// TODO - update UpdateConfig with the required logic for this service method.
	// Add api_config_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("UpdateConfig method not implemented")
}
