...
// checks if the ScheduleRelationBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleRelationBase{}

// ScheduleRelationBase struct for ScheduleRelationBase
type ScheduleRelationBase struct {
...
func (o ScheduleRelationBase) MarshalJSON() ([]byte, error) {
...
func (o ScheduleRelationBase) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleRelationBase struct {
	value *ScheduleRelationBase
	isSet bool
}

func (v NullableScheduleRelationBase) Get() *ScheduleRelationBase {
	return v.value
}

func (v *NullableScheduleRelationBase) Set(val *ScheduleRelationBase) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleRelationBase) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleRelationBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleRelationBase(val *ScheduleRelationBase) *NullableScheduleRelationBase {
	return &NullableScheduleRelationBase{value: val, isSet: true}
}

func (v NullableScheduleRelationBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleRelationBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
