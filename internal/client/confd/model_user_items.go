...
func (o *UserItems) UnmarshalJSON(data []byte) (err error) {
	...
	varUserItems := _UserItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserItems)

	if err != nil {
		return err
	}

	*o = UserItems(varUserItems)
