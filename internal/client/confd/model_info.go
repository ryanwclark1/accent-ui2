...
type Info struct {
	// UUID of the Accent server
	Uuid *string `json:"uuid,omitempty"`
	// Version of the Accent server
	AccentVersion *string `json:"accent_version,omitempty"`
}
...
// GetAccentVersion returns the AccentVersion field value if set, zero value otherwise.
func (o *Info) GetAccentVersion() string {
	if o == nil || IsNil(o.AccentVersion) {
		var ret string
		return ret
	}
	return *o.AccentVersion
}

// GetAccentVersionOk returns a tuple with the AccentVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Info) GetAccentVersionOk() (*string, bool) {
	if o == nil || IsNil(o.AccentVersion) {
		return nil, false
	}
	return o.AccentVersion, true
}
...
// SetAccentVersion gets a reference to the given string and assigns it to the AccentVersion field.
...
func (o Info) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AccentVersion) {
		toSerialize["accent_version"] = o.AccentVersion
	}
