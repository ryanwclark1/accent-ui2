...
// checks if the SwitchboardFallbacks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwitchboardFallbacks{}

// SwitchboardFallbacks struct for SwitchboardFallbacks
type SwitchboardFallbacks struct {
...
func (o SwitchboardFallbacks) MarshalJSON() ([]byte, error) {
...
func (o SwitchboardFallbacks) ToMap() (map[string]interface{}, error) {
...
type NullableSwitchboardFallbacks struct {
	value *SwitchboardFallbacks
	isSet bool
}

func (v NullableSwitchboardFallbacks) Get() *SwitchboardFallbacks {
	return v.value
}

func (v *NullableSwitchboardFallbacks) Set(val *SwitchboardFallbacks) {
	v.value = val
	v.isSet = true
}

func (v NullableSwitchboardFallbacks) IsSet() bool {
	return v.isSet
}

func (v *NullableSwitchboardFallbacks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwitchboardFallbacks(val *SwitchboardFallbacks) *NullableSwitchboardFallbacks {
	return &NullableSwitchboardFallbacks{value: val, isSet: true}
}

func (v NullableSwitchboardFallbacks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwitchboardFallbacks) UnmarshalJSON(src []byte) error {
	v.isSet = true
