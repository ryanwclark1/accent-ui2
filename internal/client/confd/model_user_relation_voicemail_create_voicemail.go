...
// checks if the UserRelationVoicemailCreateVoicemail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserRelationVoicemailCreateVoicemail{}

// UserRelationVoicemailCreateVoicemail struct for UserRelationVoicemailCreateVoicemail
type UserRelationVoicemailCreateVoicemail struct {
...
type _UserRelationVoicemailCreateVoicemail UserRelationVoicemailCreateVoicemail
...
func NewUserRelationVoicemailCreateVoicemail(context string, number string) *UserRelationVoicemailCreateVoicemail {
	this := UserRelationVoicemailCreateVoicemail{}
...
func (o UserRelationVoicemailCreateVoicemail) MarshalJSON() ([]byte, error) {
...
func (o UserRelationVoicemailCreateVoicemail) ToMap() (map[string]interface{}, error) {
...
func (o *UserRelationVoicemailCreateVoicemail) UnmarshalJSON(data []byte) (err error) {
	...
	varUserRelationVoicemailCreateVoicemail := _UserRelationVoicemailCreateVoicemail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserRelationVoicemailCreateVoicemail)

	if err != nil {
		return err
	}

	*o = UserRelationVoicemailCreateVoicemail(varUserRelationVoicemailCreateVoicemail)

	return err
}

type NullableUserRelationVoicemailCreateVoicemail struct {
	value *UserRelationVoicemailCreateVoicemail
	isSet bool
}

func (v NullableUserRelationVoicemailCreateVoicemail) Get() *UserRelationVoicemailCreateVoicemail {
	return v.value
}

func (v *NullableUserRelationVoicemailCreateVoicemail) Set(val *UserRelationVoicemailCreateVoicemail) {
	v.value = val
	v.isSet = true
}

func (v NullableUserRelationVoicemailCreateVoicemail) IsSet() bool {
	return v.isSet
}

func (v *NullableUserRelationVoicemailCreateVoicemail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserRelationVoicemailCreateVoicemail(val *UserRelationVoicemailCreateVoicemail) *NullableUserRelationVoicemailCreateVoicemail {
	return &NullableUserRelationVoicemailCreateVoicemail{value: val, isSet: true}
}

func (v NullableUserRelationVoicemailCreateVoicemail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserRelationVoicemailCreateVoicemail) UnmarshalJSON(src []byte) error {
	v.isSet = true
