...
// checks if the UserImportIDs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserImportIDs{}

// UserImportIDs struct for UserImportIDs
type UserImportIDs struct {
	// Extension ID
...
// and a boolean to check if the value has been set.
func (o *UserImportIDs) GetUserIdOk() (*int32, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o UserImportIDs) MarshalJSON() ([]byte, error) {
...
func (o UserImportIDs) ToMap() (map[string]interface{}, error) {
...
type NullableUserImportIDs struct {
	value *UserImportIDs
	isSet bool
}

func (v NullableUserImportIDs) Get() *UserImportIDs {
	return v.value
}

func (v *NullableUserImportIDs) Set(val *UserImportIDs) {
	v.value = val
	v.isSet = true
}

func (v NullableUserImportIDs) IsSet() bool {
	return v.isSet
}

func (v *NullableUserImportIDs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserImportIDs(val *UserImportIDs) *NullableUserImportIDs {
	return &NullableUserImportIDs{value: val, isSet: true}
}

func (v NullableUserImportIDs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserImportIDs) UnmarshalJSON(src []byte) error {
	v.isSet = true
