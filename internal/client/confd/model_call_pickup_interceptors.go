...
// checks if the CallPickupInterceptors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallPickupInterceptors{}

// CallPickupInterceptors struct for CallPickupInterceptors
type CallPickupInterceptors struct {
...
func (o CallPickupInterceptors) MarshalJSON() ([]byte, error) {
...
func (o CallPickupInterceptors) ToMap() (map[string]interface{}, error) {
...
type NullableCallPickupInterceptors struct {
	value *CallPickupInterceptors
	isSet bool
}

func (v NullableCallPickupInterceptors) Get() *CallPickupInterceptors {
	return v.value
}

func (v *NullableCallPickupInterceptors) Set(val *CallPickupInterceptors) {
	v.value = val
	v.isSet = true
}

func (v NullableCallPickupInterceptors) IsSet() bool {
	return v.isSet
}

func (v *NullableCallPickupInterceptors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallPickupInterceptors(val *CallPickupInterceptors) *NullableCallPickupInterceptors {
	return &NullableCallPickupInterceptors{value: val, isSet: true}
}

func (v NullableCallPickupInterceptors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallPickupInterceptors) UnmarshalJSON(src []byte) error {
	v.isSet = true
