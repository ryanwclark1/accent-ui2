...
// checks if the GroupRelationIncalls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRelationIncalls{}

// GroupRelationIncalls struct for GroupRelationIncalls
type GroupRelationIncalls struct {
...
func (o GroupRelationIncalls) MarshalJSON() ([]byte, error) {
...
func (o GroupRelationIncalls) ToMap() (map[string]interface{}, error) {
...
type NullableGroupRelationIncalls struct {
	value *GroupRelationIncalls
	isSet bool
}

func (v NullableGroupRelationIncalls) Get() *GroupRelationIncalls {
	return v.value
}

func (v *NullableGroupRelationIncalls) Set(val *GroupRelationIncalls) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRelationIncalls) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRelationIncalls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRelationIncalls(val *GroupRelationIncalls) *NullableGroupRelationIncalls {
	return &NullableGroupRelationIncalls{value: val, isSet: true}
}

func (v NullableGroupRelationIncalls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRelationIncalls) UnmarshalJSON(src []byte) error {
	v.isSet = true
