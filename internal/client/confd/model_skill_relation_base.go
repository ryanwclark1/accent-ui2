...
// checks if the SkillRelationBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkillRelationBase{}

// SkillRelationBase struct for SkillRelationBase
type SkillRelationBase struct {
...
func (o SkillRelationBase) MarshalJSON() ([]byte, error) {
...
func (o SkillRelationBase) ToMap() (map[string]interface{}, error) {
...
type NullableSkillRelationBase struct {
	value *SkillRelationBase
	isSet bool
}

func (v NullableSkillRelationBase) Get() *SkillRelationBase {
	return v.value
}

func (v *NullableSkillRelationBase) Set(val *SkillRelationBase) {
	v.value = val
	v.isSet = true
}

func (v NullableSkillRelationBase) IsSet() bool {
	return v.isSet
}

func (v *NullableSkillRelationBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkillRelationBase(val *SkillRelationBase) *NullableSkillRelationBase {
	return &NullableSkillRelationBase{value: val, isSet: true}
}

func (v NullableSkillRelationBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkillRelationBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
