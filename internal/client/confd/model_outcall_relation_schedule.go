...
// checks if the OutcallRelationSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutcallRelationSchedule{}

// OutcallRelationSchedule struct for OutcallRelationSchedule
type OutcallRelationSchedule struct {
...
func (o OutcallRelationSchedule) MarshalJSON() ([]byte, error) {
...
func (o OutcallRelationSchedule) ToMap() (map[string]interface{}, error) {
...
type NullableOutcallRelationSchedule struct {
	value *OutcallRelationSchedule
	isSet bool
}

func (v NullableOutcallRelationSchedule) Get() *OutcallRelationSchedule {
	return v.value
}

func (v *NullableOutcallRelationSchedule) Set(val *OutcallRelationSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableOutcallRelationSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableOutcallRelationSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOutcallRelationSchedule(val *OutcallRelationSchedule) *NullableOutcallRelationSchedule {
	return &NullableOutcallRelationSchedule{value: val, isSet: true}
}

func (v NullableOutcallRelationSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOutcallRelationSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
